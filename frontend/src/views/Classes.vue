  ...
  <div id="main">
    <div id="parent">
      ...
      <div id="sideBar" class="child1">
        <button @click="showInfo('undergraduate')">
          <b>Undergraduate</b
          ><i id="icon2" class="material-icons">expand_more</i>
        </button>
        <br />
        ...
        <button @click="showInfo('graduate')">
          <b>Graduate</b><i id="icon3" class="material-icons">expand_more</i>
        </button>
        <br />
        ...
        <button @click="showInfo('courses')">
          <b>Courses</b><i id="icon4" class="material-icons">expand_more</i>
        </button>
        <br />
        ...
        <button @click="showInfo('tas')">
          <b>Teaching Assitants</b
          ><i id="icon5" class="material-icons">expand_more</i>
        </button>
        <br />
        ...
        <button @click="showInfo('funding')">
          <b>Funding</b><i id="icon6" class="material-icons">expand_more</i>
        </button>
        <br />
    ...
    return {
      ...
      alt_classes: [
        ...
        },
        {
          ...
          instructor:
            "Giulia Alberini, Elizabeth Patitsas (Fall) Giulia Alberini (Winter), Ben Yu (Summer)",
          ...
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/3_COMP_202_A1i3t4M.pdf",
...

        {
          ...
          other: "",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/5_COMP_206_enH8696.pdf",
...

        {
          ...
          terms: "Fall 2019, Winter 2020",
          instructor:
            "Michael Langer, Giulia Alberini (Fall) Reihaneh Rabbany, Giulia Alberini (Winter)",
          prereq:
          ...
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/8_COMP_250_JCxX2Fx.pdf",
...

        {
          ...
          prereq: "COMP 250",
          other:
            "Not open to students who have taken or are taking COMP 252.COMP 251 uses basic counting techniques (permutations and combinations) that are covered in MATH 240 and 363, but not in MATH 235. These techniques will be reviewed for the benefit of MATH 235 students.",
...

        {
          ...
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/11_COMP_273_qtDlIoA.pdf",
...

        {
          ...
          other: "3 Hours",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/13_COMP_302_ndstwmd.pdf",
...

        {
          ...
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/15_COMP_307_fM33LLO.pdf",
...

        {
          ...
          other:
            "At the end of the class, interested students are encouraged to join the McGill team to participate in the annual ACM International Collegiate Programming Competition.",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/18_COMP_321_EhWKr7m.pdf",
...

        {
          ...
          other: "",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/19_COMP_322_VL3T4aJ.pdf",
...

        {
          ...
          other: "",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/35_COMP_421_2b2VVIB.pdf",
...

        {
          ...
          other: "",
          syllabus:
            "https://www.cs.mcgill.ca/media/academic/courses/41_COMP_521_mrkKEsg.pdf",
